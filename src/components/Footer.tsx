...
const navigation = [
  { name: 'EPA', href: 'https://www.epa-bienestar.com.ar' },
  { name: 'Programa', href: 'https://www.epa-bienestar.com.ar/prevencion.html' },
  { name: 'Equipo', href: 'https://www.epa-bienestar.com.ar/equipo.html' },
  ...
  return (
    <footer className="border-t border-neutral-200 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <p className="py-12 text-center text-sm text-neutral-900">&copy; 2025 PLAN BIENESTAR 100 DIAS</p>
        <p className="py-12 text-center text-sm text-neutral-900">Programas de EPA Bienestar IA. Derechos Reservados.</p>
      </div>
    </footer>
  );
}
