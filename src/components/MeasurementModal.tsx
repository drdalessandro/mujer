...
const [modalValues, setModalValues] = useState<MeasurementValues>({
  ...
  const addResource = (): void => {
    ...
    } else if (type === 'IMC' && modalValues.imc) {
    createMeasurement(modalValues.imc);
    } else if (type === 'Colesterol Total' && modalValues.colesterolTotal) {
    createMeasurement(modalValues.colesterolTotal);
    } else if (type === 'LDL Colesterol' && modalValues.ldlColesterol) {
    createMeasurement(modalValues.ldlColesterol);
    } else if (type === 'HDL Colesterol' && modalValues.hdlColesterol) {
    createMeasurement(modalValues.hdlColesterol);
    } else if (type === 'Triglicéridos' && modalValues.triglicéridos) {
    createMeasurement(modalValues.triglicéridos);
    } else if (type === 'Glucosa Ayunas' && modalValues.glucosaAyunas) {
    createMeasurement(modalValues.glucosaAyunas);
    } else if (type === 'Hemoglobina A1c' && modalValues.hemoglobinaA1c) {
    createMeasurement(modalValues.hemoglobinaA1c);
    } else if (type === 'Actividad Física Semanal' && modalValues.actividadFísicaSemanal) {
    createMeasurement(modalValues.actividadFísicaSemanal);
    } else if (type === 'Calidad Sueño' && modalValues.calidadSueño) {
    createMeasurement(modalValues.calidadSueño);
    } else if (type === 'Porciones Frutas/Verduras' && modalValues.porcionesAlimentos) {
    createMeasurement(modalValues.porcionesAlimentos);
  }
    ...
    },
{
    modalType: 'IMC',
    inputType: 'number',
    value: modalValues.imc,
    name: 'imc',
    placeholder: 'kg/m²',
  },
  {
    modalType: 'Colesterol Total',
    inputType: 'number',
    value: modalValues.colesterolTotal,
    name: 'colesterolTotal',
    placeholder: 'mg/dL',
  },
  {
    modalType: 'LDL Colesterol',
    inputType: 'number',
    value: modalValues.ldlColesterol,
    name: 'ldlColesterol',
    placeholder: 'mg/dL',
  },
  {
    modalType: 'HDL Colesterol',
    inputType: 'number',
    value: modalValues.hdlColesterol,
    name: 'hdlColesterol',
    placeholder: 'mg/dL',
  },
  {
    modalType: 'Triglicéridos',
    inputType: 'number',
    value: modalValues.triglicéridos,
    name: 'triglicéridos',
    placeholder: 'mg/dL',
  },
  {
    modalType: 'Glucosa Ayunas',
    inputType: 'number',
    value: modalValues.glucosaAyunas,
    name: 'glucosaAyunas',
    placeholder: 'mg/dL',
  },
  {
    modalType: 'Hemoglobina A1c',
    inputType: 'number',
    value: modalValues.hemoglobinaA1c,
    name: 'hemoglobinaA1c',
    placeholder: '%',
  },
  {
    modalType: 'Actividad Física Semanal',
    inputType: 'number',
    value: modalValues.actividadFísicaSemanal,
    name: 'actividadFísicaSemanal',
    placeholder: 'min/semana',
  },
  {
    modalType: 'Calidad Sueño',
    inputType: 'number',
    value: modalValues.calidadSueño,
    name: 'calidadSueño',
    placeholder: 'Score 0-21',
  },
  {
    modalType: 'Porciones Frutas/Verduras',
    inputType: 'number',
    value: modalValues.porcionesAlimentos,
    name: 'porcionesAlimentos',
    placeholder: 'porciones/día',
  },
  ];
