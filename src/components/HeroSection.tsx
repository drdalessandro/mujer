...
export function HeroSection(): JSX.Element {
  return (
    <div className="relative bg-gradient-radial from-purple-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between space-x-6 py-6 lg:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden space-x-4 md:flex lg:space-x-10">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-white text-base font-normal hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Servicios</span>
                      <ChevronDownIcon
              ...
              <a href="https://www.epa-bienestar.com.ar/programa/mujer/index.html" className="text-base font-normal text-gray-500 hover:text-gray-900">8 Pasos para tu Salud</a>
              <a href="https://calendar.app.google/VhQ6gLKJq1341TJV6" className="text-base font-normal text-gray-500 hover:text-gray-900">Solicitar Turnos</a>
              <Popover className="relative">
                {({ open }) => (
                  <>
                    <Popover.Button
              ...
              <div className="space-y-6 py-6 px-5">
                ...
                <div>
                  <p className="mt-6 text-center text-base font-normal text-gray-500">
                    Ya tiene una cuenta?
                    <Link to="/signin" className="ml-6 text-purple-600 hover:text-purple-500">
                      Ingresar!
                    </Link>
                  <Link
                    to="/register"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-base font-normal text-white shadow-sm hover:bg-purple-700"
                  >
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex w-full flex-col items-center pt-8 pb-8 text-left sm:items-start sm:pb-36 md:py-36">
          <div className="flex flex-col items-center sm:items-start">
            <h1 className="text-center text-3xl font-medium tracking-wider text-gray-900 sm:text-left sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              <p>Prevención</p>
              <p className="text-purple-600">Salud de la Mujer</p>
            </h1>
	    ...
	    <div className="mt-8 sm:flex sm:justify-center md:mt-20 lg:justify-start">
              <div className="rounded-md shadow">
                <a href="/signin" className="flex w-full items-center justify-center rounded-md border border-transparent bg-purple-600 py-4 px-20 text-lg font-normal text-white hover:bg-purple-700">Ingresar!</a>
              </div>
            </div>
          </div>
          <img
