    ...
    case 'Actividad Física Semanal':
      return {
        ...
        code: {
          coding: [{
            code: '82290-8',
            display: 'Physical activity weekly',
            system: 'http://loinc.org',
          }],
    ...
    case 'Calidad Sueño':
      return {
        ...
        code: {
          coding: [{
            code: '93831-6',
            display: 'Pittsburgh Sleep Quality Index',
            system: 'http://loinc.org',
          }],
          text: 'Calidad del Sueño (PSQI)',
        },
        valueQuantity: {
          code: '1',
          system: 'http://unitsofmeasure.org',
      ...
      return {
        ...
        valueCodeableConcept: {
          coding: [{
            ...
            code: firstValue, // '266919005' = Never smoker, '8517006' = Ex-smoker, '77176002' = Current smoker
            display: secondValue || firstValue,
          }],
          text: secondValue || firstValue,
        },
        effectiveDateTime: date,
        status: 'final',
      };

    case 'Porciones Frutas/Verduras':
      return {
        resourceType: 'Observation',
        subject,
        category: [{
        ...
        code: {
          coding: [{
            code: '89574-8',
            display: 'Fruit intake 24 hour',
            system: 'http://loinc.org',
          }],
          text: 'Porciones Frutas y Verduras Diarias',
        },
        valueQuantity: {
          code: '/d',
          system: 'http://unitsofmeasure.org',
