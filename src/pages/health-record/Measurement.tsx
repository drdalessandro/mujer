...
export const measurementsMeta: measurementsMetaType = {
  ...
  bmi: {
    id: 'bmi',
    code: '39156-5',
    title: 'IMC (Índice Masa Corporal)',
    description: 'El IMC es una medida que relaciona peso y altura para determinar sobrepeso u obesidad. Valores normales: 18.5-24.9 kg/m². Se calcula automáticamente pero también puede registrarse manualmente.',
    chartDatasets: [{
      label: 'IMC',
      backgroundColor,
      borderColor,
  ...
  'weekly-physical-activity': {
    id: 'weekly-physical-activity',
    code: '82290-8',
    title: 'Actividad Física Semanal',
    description: 'Medición del tiempo total de actividad física moderada o vigorosa por semana. Recomendación: ≥150 minutos/semana de actividad moderada o ≥75 minutos/semana de actividad vigorosa.',
    chartDatasets: [{
  ...
  'sleep-quality': {
    ...
    description: 'El índice de calidad del sueño de Pittsburgh evalúa la calidad del sueño. Puntuación: 0-21. Una puntuación >5 indica mala calidad del sueño.',
    chartDatasets: [{
      label: 'PSQI Score',
      backgroundColor,
      borderColor,
  ...
  'fruit-vegetable-intake': {
    ...
    code: '89574-8',
    title: 'Porciones Frutas y Verduras',
    description: 'Consumo diario de frutas y verduras. Recomendación: al menos 5 porciones diarias combinadas de frutas y verduras para una dieta saludable.',
    chartDatasets: [{
      label: 'Porciones/Día',
      backgroundColor,
      borderColor,
