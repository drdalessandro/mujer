...
export default function Profile(): JSX.Element | null {
  ...
  const toggleButtonIcons = (name: string): JSX.Element => {
    if (activeInputName === name) {
      return <CheckIcon className="ml-2 h-8 w-8 self-center text-gray-400 hover:text-purple-700" />;
    } else {
      return <PencilIcon className="ml-2 h-6 w-6 self-center text-gray-400 hover:text-purple-700" />;
    }
  };
        ...
        <>
          {activeInputName === 'gender' ? (
            <div className="flex space-x-2">
              ...
              >
                <CheckIcon className="h-8 w-8 self-center text-gray-400 hover:text-purple-700" />
              </Button>
            </div>
          ) : (
            <Button onClick={() => setActiveInputName('gender')}>
              <div className="flex items-center text-gray-400 hover:text-purple-700">
