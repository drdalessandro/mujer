              ...
              <InfoSection title="Datos de Atención Primaria">
                <div className="mx-auto px-4 py-5 text-center sm:px-6">
                  ...
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center rounded-md border border-transparent bg-purple-700 px-5 py-3 text-base font-medium text-white hover:bg-purple-900"
                  >
